...
class DebateTest(TestCase):
    ...
    def test_from_file(self):
        debate = Debate.from_file(
            os.path.join(self.resources_json_path, 'debate_Dáil Éireann_2016-05-25.json')
        )
        self.assertEqual(
            debate.serialize()['chamber'],
            'Dáil Éireann'
        )
    ...
    def test_content_by_speaker(self):
        ...
        self.assertEqual(
            ...
            ['SeanOFearghaillFF', 'MichaelMartin', 'EndaKenny', 'GerryAdams', 'WillieODea', 'BrendanHowlin', 'RoisinShortall', 'RichardBoydBarrett', 'ThomasByrne', 'DannyHealyRae', 'LouiseOReilly', 'DavidCullinane', 'MattieMcGrath', 'MaryLouMcDonald', 'JoanCollins', 'SeanCroweSF', 'SeanSherlock', 'RuthCoppinger', 'BridSmith', 'CaoimhglinOCaolain', 'JimOCallaghan', 'SeamusHealy', 'LeoVaradkar', 'JohnBrady', 'WilliamPenrose', 'FinianMcGrath', 'FrankORourke', 'MickWallace', 'NiamhSmyth', 'DavidStanton', 'AlanFarrell', 'FrancesFitzgerald', 'JonathanOBrien', 'MickBarry', 'JohnLahart', 'ClareDaly', 'RobertTroy', 'GinoKenny', 'MichaelFitzmaurice', 'EoinOBroin', 'ThomasPringle', 'StephenDonnelly', 'PearseDoherty', 'PatBuckley', 'DonnchadhOLaoghaire', 'DessieEllis', 'ImeldaMunster', 'PaschalDonohoe', 'TonyMcLoughlin', 'BernardJDurkan', 'MichaelWDArcy', 'DamienEnglishFG', 'SimonCoveney', 'TimDooley']
        )
